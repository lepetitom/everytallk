<?php
/*
Template Name: Single No Sidebar Template  2
*/
?>
<?php
    global $post;
...
?>
<div class="site-content atbs-single-style-no-sidebar-2 <?php echo esc_attr($stickySocialShareBar__Class);?> <?php echo esc_attr($infinity_wrapDivClass);?> <?php echo esc_attr($cerisExtension);?>">
