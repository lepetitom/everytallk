...
?>
<div class="site-content atbs-single-style-15 <?php echo esc_attr($stickySocialShareBar__Class);?> <?php echo esc_attr($infinity_wrapDivClass);?> <?php echo esc_attr($cerisExtension);?>">
