...
?>
<div class="site-content atbs-single-style-no-sidebar-3 <?php echo esc_attr($stickySocialShareBar__Class);?> <?php echo esc_attr($infinity_wrapDivClass);?> <?php echo esc_attr($cerisExtension);?>">
    <div class="single-entry-wrap <?php if(($infinityScrolling != '') || ($infinityScrolling != 0)): echo 'single-infinity-container'; endif;?>">
        <div class="atbs-ceris-block atbs-ceris-block-<?php echo esc_attr($currentPostID);?> atbs-ceris-block--fullwidth single-entry ceris-single element-scroll-percent <?php if($infinity_wrapDivClass == '') echo 'single-end-infinity';?> <?php echo esc_attr($bookmarkClass);?> <?php if(($infinityScrolling != '') || ($infinityScrolling != 0)): echo 'single-infinity-inner'; endif;?>" data-url-to-load="<?php echo esc_url($infinity_PermalinkToLoad);?>" data-post-title-to-load="<?php echo esc_attr($nextPostTitle);?>" data-postid="<?php echo esc_attr($currentPostID);?>" data-wcount="<?php echo esc_attr($article_wcount);?>" data-next-wcount="<?php echo esc_attr($next_article_wcount);?>">
            <div class="atbs-ceris-block atbs-ceris-block--fullwidth single-header-wrap single-no-sidebar">
