<?php
/*
Template Name: Single No Sidebar Template  1
*/
?>
<?php
    global $post;
...
?>
<div class="site-content atbs-single-style-no-sidebar-1 <?php echo esc_attr($stickySocialShareBar__Class);?> <?php echo esc_attr($infinity_wrapDivClass);?> <?php echo esc_attr($cerisExtension);?>">
                                    ...
                                    <?php
                                        ...
                                        if(($postFormat == 'video') || ($postFormat == 'gallery')) {
                                            ...
                                            if (($featuredImageSTS != 0) && (ceris_core::bk_check_has_post_thumbnail($postID))) {
                                                ...
                                                echo get_the_post_thumbnail($postID, 'ceris-m-2_1');
                                				if($featImgCaption != '') :
