...
<footer class="site-footer footer-1 <?php if($inverseClass == "yes") echo " site-footer--inverse inverse-text";?>">
    ...
    <?php
        if ((isset($ceris_option['bk-footer--mailchimp-bg']['background-image'])) && ($ceris_option['bk-footer--mailchimp-bg']['background-image'] != '')) :
            $imgBGStyle = "background-image: url('".$ceris_option['bk-footer--mailchimp-bg']['background-image'] ."')";
        else :
            $imgBGStyle = '';
        endif;
    ?>
	<div class="site-footer__section site-footer__section--seperated">
        <?php
        if($ceris_option['bk-footer--mailchimp-bg']['background-image'] != '') {
