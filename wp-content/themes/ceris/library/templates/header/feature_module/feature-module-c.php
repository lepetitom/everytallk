...
$theModule = new ceris_featured_module_c;       
$the_query = bk_get_query::ceris_query($moduleConfigs);              //get query
$block_str = '';
$block_str .= '<div class="header-feature-module atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin feature-module-c atbs-ceris-posts-feature-c-update ceris-dark-mode">';
