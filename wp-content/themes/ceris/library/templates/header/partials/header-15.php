...
<header class="site-header ">
		...
		<div class="container">
			<div class="row row--flex row--vertical-center">
				...
				<div class="col-xs-3 text-right <?php if($inverseHeaderElements == "yes") echo " navigation-bar--inverse"; ?>">
                    <div class="flexbox flexbox--middle flexbox-wrap flexbox-right-x <?php if(is_user_logged_in()) echo 'has-bookmark-list';?>">
                        <?php
                            if(is_user_logged_in()) :
                                echo '<div class="ceris-bookmark-list-wrap flexbox__item text-left">'; 
    ...
    <!-- Navigation bar -->
	<nav class="navigation-bar navigation-bar--fullwidth navigation-custom-bg-color <?php if($inverseClass == "yes") echo " navigation-bar--inverse"; ?> hidden-xs hidden-sm js-sticky-header-holder <?php if($inverseClass == "yes") echo " navigation-bar--inverse";?>">
		<div class="container">
