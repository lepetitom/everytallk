<?php 
    ...
    if ((isset($ceris_option['bk-menu-postion-switch']))){ 
        $postionClass = 'yes';
        if((($ceris_option['bk-menu-postion-switch']) == 1) ):
            $textSwitch = 'text-center'; //center
            
        elseif((($ceris_option['bk-menu-postion-switch']) == 2)):
            $textSwitch = 'text-left'; //left
        else:
            $textSwitch = 'text-right'; //right
        endif;
    }else {
        $postionClass = '';
    }
...
<header class="site-header">
    ...
    <nav class="navigation-bar navigation-bar--fullwidth hidden-xs hidden-sm js-sticky-header-holder <?php if($inverseClass == "yes") echo " navigation-bar--inverse";?>">
		<div class="navigation-bar__inner">
            ...
            <div class="navigation-wrapper navigation-bar__section js-priority-nav <?php if($postionClass == "yes") echo esc_attr($textSwitch);?>">
				<?php 
            ...
            <div class="navigation-bar__section space-seperated flexbox flexbox--middle">
                ...
                <button type="submit" class="navigation-bar-btn btn-search js-search-popup">
                    <i class="mdicon mdicon-search"></i><span><?php esc_html_e('Search','ceris'); ?></span>
                </button>
                <div class="lwa lwa-template-modal flexbox-wrap flexbox-center-y <?php if(is_user_logged_in()) echo 'has-bookmark-list';?>">
                    <?php
                        if(is_user_logged_in()) : 
