<?php
if (!class_exists('ceris_update_overlay_7')) {
    class ceris_update_overlay_7 {
                ...
                <div class="post__text <?php if(isset($postAttr['additionalTextClass']) && ($postAttr['additionalTextClass'] != null)) echo esc_attr($postAttr['additionalTextClass']);?>">
                    <div class="post__text-inner">
                        ...
                        <div class="post__text--wrap">
                            ...
                            <div class="entry-author entry-author--horizontal item-justify-center <?php if(isset($postAttr['additionalAuthorClass']) && ($postAttr['additionalAuthorClass'] != null)) echo esc_attr($postAttr['additionalAuthorClass']);?>">
                                <?php 
