<?php
if (!class_exists('ceris_update_vertical_6')) {
    class ceris_update_vertical_6 {
                            ...
                            <div class="post__text--col-2">
                                ...
                                <div class="post__readmore  <?php if(isset($postAttr['additionalTextReadMore']) && ($postAttr['additionalTextReadMore'] != null)) echo esc_attr($postAttr['additionalTextReadMore']);?>">
                                    <a href="<?php echo get_permalink($postID);?>" class="button__readmore">
                                        <span class="readmore__text"><span><?php esc_html_e('Read more','ceris'); ?></span><i class="mdicon mdicon-arrow_forward"></i></span>
                                    </a>
                                </div>        
                                <?php
                                    endif;
