<?php
if (!class_exists('ceris_post_overlay_6')) {
    class ceris_post_overlay_6 {
				...
				<div class="post__text <?php if(isset($postAttr['additionalTextClass']) && ($postAttr['additionalTextClass'] != null)) echo esc_attr($postAttr['additionalTextClass']);?>">
					<div class="post__text-wrap">
						<div class="post__text-inner ">
							...
							<?php if((isset($postAttr['meta']) && ($postAttr['meta'] != '')) && (isset($postAttr['readmore']) && ($postAttr['readmore'] != ''))): ?>
                            <div class="post--overlay-footer flexbox-wrap">
                                <?php if (isset($postAttr['meta']) && ($postAttr['meta'] != '')) :  ?>
								<div class="entry-author <?php if(isset($postAttr['additionalAuthorClass']) && ($postAttr['additionalAuthorClass'] != null)) echo esc_attr($postAttr['additionalAuthorClass']);?>">
                                    <?php 
