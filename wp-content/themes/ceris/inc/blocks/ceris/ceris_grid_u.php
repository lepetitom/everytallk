    ...
    class ceris_grid_u {
        ...
        public function render( $page_info ) {
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin ceris-grid-u atbs-ceris-post--grid-b-update clearfix '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules ($the_query){
            ...
            $postMainAttr = array (
                ...
                'additionalClass'      => 'post-fullwidth-text-center-top post__thumb-700 remove-margin-bottom-lastchild icon-right-center '.$bypasspostAnimationDetech.'',
...
//                'except_length'        => '15',
            ...
            $postOverlayAttr = array (
                ...
                'additionalClass'      => 'post--overlay-bottom post--overlay-md post--overlay-padding-lg post--overlay-top-bottom posts-has-smaller-post-cat '.$bypasspostAnimationDetech,
            ...
            $carouselID = uniqid('carousel-feature-slider-');
             ...
             while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                elseif($currentPost > 0):
                    ...
                    if($currentPost == 1):
                        $render_modules .= '<div class="container post-sub atbs-ceris-posts-latest--overlay ">';
                        if(($maxPosts >= 1) && ($maxPosts < 5) ):
                            $render_modules .= '<div class="atbs-ceris-carousel dots-circle carousel-flex carousel-flex-space-20 ">';
                        else: 
                            $render_modules .= '<div class="owl-carousel js-carousel-3i30m5-update atbs-ceris-carousel dots-circle">';
                        endif;
                    endif;
                    if($bypassPostIconDetech != 1) {
                        $addClass = '';
                        ...
                        $postIconAttr['postIconClass']  = ceris_core::get_post_icon_class($postIconAttr['iconType'], 'small', 'top-right', $addClass);
                        if(($postIconAttr['iconType'] == 'gallery') || ($postIconAttr['iconType'] == 'review')):
                            $postIconAttr['iconType'] = '';
                        endif;
