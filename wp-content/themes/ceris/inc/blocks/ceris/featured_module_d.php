<?php
if (!class_exists('ceris_featured_module_d')) {
    class ceris_featured_module_d {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_featured_module_d-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin feature-module-d atbs-ceris-posts-feature-b-update '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules ($the_query){
            ...
            $postHorizontalHTML = new ceris_post_horizontal_3;         
            $postHorizontalAttr = array (
                'cat'                  => $catStyle,
                'catClass'             => $cat_Class,
                'additionalClass'      => 'post-meta--large post--horizontal-fullwidth-thumb-large post__thumb-800 remove-margin-bottom-lastchild icon-right-center inverse-text '.$bypasspostAnimationDetech.'',
