...
if (!class_exists('ceris_grid_q')) {
    class ceris_grid_q {
        ...
        public function render( $page_info ) {
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin ceris-grid-q atbs-ceris-mosaic atbs-ceris-mosaic--gutter-10 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
