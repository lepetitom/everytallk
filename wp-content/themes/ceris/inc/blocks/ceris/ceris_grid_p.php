...
if (!class_exists('ceris_grid_p')) {
    class ceris_grid_p {
        ...
        public function render( $page_info ) {
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin ceris-grid-p atbs-ceris-mosaic atbs-ceris-mosaic--gutter-10 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            if ( $the_query->have_posts() ) :
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();     
                    ...
                    elseif($the_query->current_post == 1) :
                        ...
                        $postOverlayAttr['typescale'] = 'typescale-2 custom-typescale-2';
                        $postOverlayAttr['meta'] = array('date');
                        ...
                        $postOverlayAttr['typescale'] = 'typescale-2 custom-typescale-2--xxs';
                        $postOverlayAttr['postID'] = get_the_ID();  
