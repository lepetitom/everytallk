<?php
if (!class_exists('ceris_posts_listing_list_c_no_sidebar')) {
    class ceris_posts_listing_list_c_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_list_c_no_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin atbs-ceris-post--list-horizontal-hasbackground atbs-ceris-posts-listing-list-c-no-sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="atbs-ceris-block__inner posts-list">';
        ...
        public function render_modules($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                ...
                $postHorizontalAttr = array (
                    'additionalClass'   => 'post--horizontal-middle post__thumb-380 clearfix post--horizontal-hasbackground '.$bypasspostAnimationDetech.' '.$bookmarkClass,
                    'cat'               => $catStyle,
