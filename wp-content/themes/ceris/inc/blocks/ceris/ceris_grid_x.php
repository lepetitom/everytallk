    ...
    class ceris_grid_x {
        ...
        public function render( $page_info ) {
            ...
            if ( $the_query->have_posts() ) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin ceris-grid-x atbs-ceris-post--grid-b-update clearfix '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules ($the_query){
            ...
            $catStyle_S = 2;
            $cat_Class_S = ceris_core::bk_get_cat_class($catStyle_S);
            
            $postMainHTML = new ceris_post_main;         
            $postMainAttr = array (
                'cat'                  => $catStyle_L,
                'catClass'             => $cat_Class_L,
                'additionalClass'      => 'post-meta--large post-fullwidth-text-center-top post__thumb-700 remove-margin-bottom-lastchild icon-right-center '.$bypasspostAnimationDetech.'',
            ...
            $carouselID = uniqid('carousel-feature-slider-');
             ...
             while ( $the_query->have_posts() ): $the_query->the_post();
                ...
                elseif($currentPost > 0):
                    ...
                    if($currentPost == 1):
                        $render_modules .= '<div class="container post-sub">';
                        if(($maxPosts >= 1) && ($maxPosts < 5) ):
                            $render_modules .= '<div class="atbs-ceris-carousel dots-circle carousel-flex carousel-flex-space-20 ">';
                        else: 
                            $render_modules .= '<div class="owl-carousel js-carousel-4i30m5-update atbs-ceris-carousel dots-circle">';
                        endif;
                    endif;
                    if($bypassPostIconDetech != 1) {
                        $addClass = '';
