<?php
if (!class_exists('ceris_block_fullwidth_two_sidebar_listing_grid_b')) {
    class ceris_block_fullwidth_two_sidebar_listing_grid_b {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_block_fullwidth_two_sidebar_listing_grid_b-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-main-col atbs-ceris-block atbs-ceris-posts-latest--overlay posts-listing-grid-b" role="main">';
        ...
        public function render_modules($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                ...
                $postOverlayAttr = array (
                    ...
                    'additionalClass'      => 'post--overlay-bottom post--overlay-floorfade post--overlay-md posts-has-smaller-post-cat post--overlay-top-bottom '.$bypasspostAnimationDetech.' '.$bookmarkClass,
