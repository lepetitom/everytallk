<?php
if (!class_exists('ceris_posts_listing_grid_e_no_sidebar')) {
    class ceris_posts_listing_grid_e_no_sidebar {
        static $pageInfo=0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_grid_e_no_sidebar-');
            $moduleConfigs = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin atbs-ceris-posts-listing-grid-e atbs-ceris-posts-listing-grid-e-no-sidebar clearfix '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                ...
                $postOverlayAttr = array (
                    'cat'                  => $catStyle,
                    'catClass'             => $cat_Class,
                    'additionalClass'      => 'post--overlay-height-520 post-grid-video-space-between post-grid-video-space-between__style-5 '.$bypasspostAnimationDetech.' '.$bookmarkClass,
