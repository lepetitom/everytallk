<?php
if (!class_exists('ceris_posts_listing_list_no_sidebar')) {
    class ceris_posts_listing_list_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_list_no_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin posts-listing-list-no-sidebar atbs-ceris-posts-latest-has--smallpost '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                ...
                $postHorizontalAttr = array (
                    'additionalClass'   => 'post--horizontal-middle post--horizontal-reverse remove-margin-bottom-lastchild post__thumb--width-450 post--horizontal-normal '.$bypasspostAnimationDetech.' '.$bookmarkClass,
                    'cat'               => $catStyle,
                    'catClass'          => $cat_Class,
