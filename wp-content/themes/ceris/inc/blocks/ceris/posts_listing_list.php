<?php
if (!class_exists('ceris_posts_listing_list')) {
    class ceris_posts_listing_list {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_list-');
            $moduleConfigs = array();
           ...
           //Post Source & Icon
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block posts-listing-list atbs-ceris-block-custom-margin atbs-ceris-posts-latest-has--smallpost '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
