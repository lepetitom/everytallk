<?php
if (!class_exists('ceris_posts_block_grid_h_no_sidebar')) {
    class ceris_posts_block_grid_h_no_sidebar {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_block_grid_h_no_sidebar-');
            ...
            if ( $the_query->have_posts()) :
                $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin ceris_posts_block_grid_h_no_sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            if ( $the_query->have_posts() ) :
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();
                    ...
                    if(($currentPost == 0) || ($currentPost == 1)) :
                        ...
                        if($currentPost == 1):
                            $render_modules .= '</div><!-- post--posts-list -->';
