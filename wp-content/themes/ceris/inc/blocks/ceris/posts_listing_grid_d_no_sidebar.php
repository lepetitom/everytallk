<?php
if (!class_exists('ceris_posts_listing_grid_d_no_sidebar')) {
    class ceris_posts_listing_grid_d_no_sidebar {
        static $pageInfo=0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_grid_d_no_sidebar-');
            $moduleConfigs = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin atbs-ceris-posts-listing-grid-d atbs-ceris-posts-listing-grid-c posts-listing-grid-d-no-sidebar clearfix '.$moduleCustomClass.' '.$blockMarginTopClass.' '.$theModuleStyle.'">';
            ...
            $block_str .= '<div class="atbs-ceris-block__inner">';//has-social-list
        ...
        public function render_modules($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                ...
                $postOverlayAttr = array (
                    'cat'                  => $catStyle,
                    'catClass'             => $cat_Class,
                    'additionalClass'      => 'post post--overlay-text-center '.$bypasspostAnimationDetech.' '.$bookmarkClass,
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();    
                   $currentPost = $the_query->current_post;     
                    ...
                    if( is_sticky(get_the_ID())):
                        $render_modules .= '<div class="list-item'.$hiddenClass.' flexbox-item-67">';
                        $postOverlayAttr['typescale'] = 'typescale-4';
                    else:
                        $render_modules .= '<div class="list-item'.$hiddenClass.' flexbox-item-33">';
