<?php
if (!class_exists('ceris_posts_listing_grid')) {
    class ceris_posts_listing_grid {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_grid-');
            $moduleConfigs = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block posts-listing-grid atbs-ceris-block-custom-margin atbs-ceris-posts--vertical-text-not-fullwidth '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
