<?php
if (!class_exists('ceris_posts_listing_list_b_no_sidebar')) {
    class ceris_posts_listing_list_b_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_list_b_no_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin posts-listing-list-b-no-sidebar atbs-ceris-posts-latest-has--smallpost-2 '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
