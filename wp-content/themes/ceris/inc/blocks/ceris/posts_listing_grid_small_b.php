<?php
if (!class_exists('ceris_posts_listing_grid_small_b')) {
    class ceris_posts_listing_grid_small_b {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_grid_small_b-');
            $moduleConfigs = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block posts-listing-grid-small atbs-ceris-block-custom-margin atbs-ceris-post--listing-grid-small-b '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="atbs-ceris-block__inner post--vertical-3i_row">';
