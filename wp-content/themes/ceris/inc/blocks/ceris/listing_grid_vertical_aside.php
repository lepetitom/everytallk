<?php
if (!class_exists('ceris_listing_grid_vertical_aside')) {
    class ceris_listing_grid_vertical_aside {
        static $pageInfo=0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_listing_grid_vertical_aside-');
            $moduleConfigs = array();
            ...
            // banner button
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin listing-grid-vertical-aside '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
