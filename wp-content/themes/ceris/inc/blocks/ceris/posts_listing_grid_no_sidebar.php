<?php
if (!class_exists('ceris_posts_listing_grid_no_sidebar')) {
    class ceris_posts_listing_grid_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_grid_no_sidebar-');
            $moduleConfigs = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin posts-listing-grid-no-sidebar atbs-ceris-posts--vertical-text-not-fullwidth '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            ...
            $block_str .= '<div class="posts-list post-list row row--space-between grid-gutter-40 items-clear-both-3">';
        ...
        public function render_modules($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                ...
                $postVerticalAttr = array (
                    'cat'                 => $catStyle,
                    'catClass'            => $cat_Class,
                    'additionalClass'     => 'ceris-post-vertical--cat-overlay post--vertical-text-not-fullwidth '.$bypasspostAnimationDetech.' '.$bookmarkClass,
                    'additionalTextClass' => '',
                ...
                while ( $the_query->have_posts() ): $the_query->the_post();    
                    ...
                    $render_modules .= '<div class="col-md-4 col-sm-6 list-item'.$hiddenClass.'">';
