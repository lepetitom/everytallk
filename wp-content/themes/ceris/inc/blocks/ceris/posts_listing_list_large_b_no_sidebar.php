<?php
if (!class_exists('ceris_posts_listing_list_large_b_no_sidebar')) {
    class ceris_posts_listing_list_large_b_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_list_large_b_no_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin posts-listing-list-large-b-no-sidebar atbs-ceris-posts-latest--text-left '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                ...
                $postOverlayAttr = array (
                    'additionalClass'      => 'text-center post--overlay-text-bottom-center--bg post--overlay-bottom post--overlay-md post--overlay-text-has-shadow '.$bypasspostAnimationDetech.' '.$bookmarkClass,
                    'cat'                  => $catStyle,
                    'catClass'             => $cat_Class,
