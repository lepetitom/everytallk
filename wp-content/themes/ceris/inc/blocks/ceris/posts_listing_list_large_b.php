<?php
if (!class_exists('ceris_posts_listing_list_large_b')) {
    class ceris_posts_listing_list_large_b {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_list_large_b-');
            $moduleConfigs = array();
           ...
           //Post Source & Icon
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block posts-listing-list-large-b atbs-ceris-block-custom-margin atbs-ceris-posts-latest--text-left '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
