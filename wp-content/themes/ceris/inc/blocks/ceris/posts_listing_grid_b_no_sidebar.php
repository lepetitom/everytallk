<?php
if (!class_exists('ceris_posts_listing_grid_b_no_sidebar')) {
    class ceris_posts_listing_grid_b_no_sidebar {
        static $pageInfo=0;
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_grid_b_no_sidebar-');
            $moduleConfigs = array();
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin posts-listing-grid-b-no-sidebar atbs-ceris-posts-latest--overlay '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
