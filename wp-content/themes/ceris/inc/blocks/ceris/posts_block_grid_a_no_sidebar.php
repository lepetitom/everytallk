<?php
if (!class_exists('ceris_posts_block_grid_a_no_sidebar')) {
    class ceris_posts_block_grid_a_no_sidebar {
        
        static $pageInfo=0;
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_block_grid_a_no_sidebar-');
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin ceris-posts-block-grid-a-no-sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
            $block_str .= '<div class="container">';
           	$block_str .= '<div class="row grid-gutter-w50-h40 row--space-between">';
            //Column 1
        ...
        public function render_modules ($the_query){
            ...
            if ( $the_query->have_posts() ) :
                $render_modules .= '<ul class="list-space-md list-space-thumb-text list-unstyled">';
