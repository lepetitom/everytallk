<?php
if (!class_exists('ceris_posts_listing_list_large_c_no_sidebar')) {
    class ceris_posts_listing_list_large_c_no_sidebar {
        
        public function render( $page_info ) {
            $block_str = '';
            $moduleID = uniqid('ceris_posts_listing_list_large_c_no_sidebar-');
            $moduleConfigs = array();
            $moduleData = array();
            ...
            $moduleInfo = array(
                ...
                'bookmarkTmp'   => array(),
                'thumbnail_size' => get_post_meta( $page_info['page_id'], $page_info['block_prefix'].'_thumbnail_size', true ),
            );
            ...
            $block_str .= '<div id="'.$moduleID.'" class="atbs-ceris-block atbs-ceris-block--fullwidth atbs-ceris-block-custom-margin posts-listing-list-large-c-no-sidebar '.$moduleCustomClass.' '.$blockMarginTopClass.'">';
        ...
        public function render_modules($the_query, $moduleInfo = ''){
            ...
            if ( $the_query->have_posts() ) :
                $postVerticalHTML = new ceris_post_vertical_10;         
                $postVerticalAttr = array (
                    'cat'                 => $catStyle,
                    'catClass'            => $cat_Class,
                    'additionalClass'     => $bypasspostAnimationDetech.' '.$bookmarkClass,
                    'additionalTextClass' => '',
                    ...
                    'except_length'     => 35,
                    'meta'              => array('author_name', 'date', 'view'),
                );
                if($moduleInfo['thumbnail_size'] == 'auto') {
                    $postVerticalAttr['thumbSize'] = 'ceris-m-auto';
                }
