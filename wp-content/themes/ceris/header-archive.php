...
if ((isset($ceris_option['bk-archive-header-switch'])) && (($ceris_option['bk-archive-header-switch']) == 1)){ 
    $bkHeaderType = ceris_core::bk_get_theme_option('bk-archive-header-type');
}else {
...
<body <?php body_class();?>>
    ...
    ?>
    <div class="site-wrapper ceris-dedicated-archive-header ceris-block-heading-loading <?php echo esc_attr(ceris_header::ceris_dedicated_page_header_class($bkHeaderType));?><?php echo esc_attr($mobileStickyHeader);?>">
        <?php
