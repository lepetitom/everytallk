...
if ((isset($ceris_option['bk-search-header-switch'])) && (($ceris_option['bk-search-header-switch']) == 1)){ 
    $bkHeaderType = ceris_core::bk_get_theme_option('bk-search-header-type');
}else {
...
<body <?php body_class();?>>
    ...
    ?>
    <div class="site-wrapper ceris-dedicated-search-header ceris-block-heading-loading <?php echo esc_attr(ceris_header::ceris_dedicated_page_header_class($bkHeaderType));?><?php echo esc_attr($mobileStickyHeader);?>">
        <?php
