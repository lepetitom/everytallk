...
class bk_widget_social_counters extends WP_Widget {
	...
	?>
        ...
        <p>
			<label for="<?php echo esc_attr($this->get_field_id( 'instagram_accesstoken' )); ?>"><strong><?php esc_html_e('Instagram Access Token:', 'ceris'); ?></strong></label>
            ...
            <i><a href="http://instagram.pixelunion.net"><?php esc_attr_e('Generate the access token here','ceris')?></a> </i>
        </p>
